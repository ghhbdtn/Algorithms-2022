...
abstract class AbstractTrieTest {
    ...
    protected fun doIteratorTest() {
        ...
        val controlSet = mutableSetOf<String>("aaaahhhhshs", "adsk", "ddk", "dcbhdf", "djhgh", "ghskm", "fghkl","mvbfkr", "rrrrrrrrrrrrrrrrr")
        val trieSet = create()
        assertFalse(
            trieSet.iterator().hasNext(),
            "Iterator of an empty set should not have any next elements."
    ...
    protected fun doIteratorRemoveTest() {
        ...
        val controlSet = mutableSetOf<String>("one", "crowd", "one738", "356909349", "crowding", "crowding145893", "tu", "tuuhfihh", "tu48759370392480203")
        val toRemove = "crowding145893"
        println("Initial set: $controlSet")
        val trieSet = create()
        for (element in controlSet) {
            trieSet += element
